...
// - the life counter starts with 100;it is subtracted the life value from life 
//   counter each frame
...
var particle = {
    ...
    update:function(){
        ...
        //2 versions of friction; this one uses less processing, 
        // but is really sensitive near <1, like 0.95 is almost useless
        //Bellow is the second version of friction, less sensitive, 
        // but with more processing
    ...
    testBounds:function(canvasWidth,canvasHeigth,width,heigth){
        ...
        this.position.setY(canvasHeigth-heigth);//to avoid the ball being trapped 
        //                                          into the bottom
        this.velocity.setAngle(-this.velocity.getAngle());
        
        
    }else if (this.position.getY()<0+heigth){
        this.position.setY(heigth);//to avoid the ball being trapped into the top 
        //                              ceiling
        this.velocity.setAngle(-this.velocity.getAngle());
}
}
