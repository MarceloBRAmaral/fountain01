...
//
//BUGS:
//1. (SOLVED)simulation is failing, some balls are trapped in the bottom;
//  (SOLUTION-the problem was solved
...
//var numParticles = 500;//number of particles to be created; there's no need as they die
